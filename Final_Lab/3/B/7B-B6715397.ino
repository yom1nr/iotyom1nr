...
// รหัส b6715397 (ใส่ 17 เพื่อให้เริ่มจากว่างเปล่า)
// ลำดับ: ว่าง, ว่าง, ว่าง, ว่าง, b, 6, 7, 1, 5, 3, 9, 7, ว่าง, ว่าง, ว่าง, ว่าง
int myID[] = {17, 17, 17, 17, 11, 6, 7, 1, 5, 3, 9, 7, 17, 17, 17, 17};
